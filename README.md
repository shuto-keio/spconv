...
1. Install boost headers to your system include path, you can use either ```sudo apt install libboost-all-dev``` or download compressed files from boost official website and copy headers to include path.
